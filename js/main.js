  ...
  <div class="row">
    ...
    <div class="col-md-8">
      ...
      <ul class="list-group">
        ...
        <li class="list-group-item"><strong>IMBD Rating:</strong> ${movie.Genre}</li>
        <li class="list-group-item"><strong>Director:</strong> ${movie.Genre}</li>
        <li class="list-group-item"><strong>Writers:</strong> ${movie.Genre}</li>
        <li class="list-group-item"><strong>Actors:</strong> ${movie.Genre}</li>
      </ul>
    </div>
  </div>
